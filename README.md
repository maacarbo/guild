...
| [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) | Decision records D1–D12 (with honest superseded/retained statuses), engagement lifecycle, deployment topology |
