...
Guild is an open-source autonomous-SDLC governance layer driving a self-hosted Multica execution substrate (stages, approval gates, handoff contracts, budget enforcement). Read these before writing code; they are normative. Architecture rationale lives in `docs/ARCHITECTURE.md` (decision records D1–D12); this file operationalizes it.

| Doc | Contents |
|---|---|
| `docs/PRODUCT.md` | Vision, flows, MVP cut |
| `docs/ARCHITECTURE.md` | Decision records D1–D12, engagement lifecycle, deployment topology |
